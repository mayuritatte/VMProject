...
public class RightClickDoubleClickTest {
	...
	@Test
	public void RightClicktestEdit() throws Exception {
	...
	@Test
	public void RightClicktestCopy() throws Exception {
	...
	@Test
	public void RightClicktestPaste() throws Exception {



		WebElement rightClickButton = driver.findElement(By.xpath("//span[contains(text(),'right click me')]"));
		WebElement pasteButton = driver.findElement(By.xpath("//span[contains(text(),'Copy')]"));
